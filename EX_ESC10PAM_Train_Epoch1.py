...
EPOCHS =1   # Define maximum Number of Epochs
FC_Size=512
SFC_Size=512
Temp=3
alpha=0.7
...
print("ECS10 PAM CNN Model is in Training Mode") 
print("---------------------------------------------------------------------------------------------------------------------")   
...
#np.save('ESC10_PAM_CNN_Parameters',Temp) # Save Temp Array as numpy array 
