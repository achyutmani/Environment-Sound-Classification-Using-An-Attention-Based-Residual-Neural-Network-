...
SAVE_DIR = 'models'
#MODEL_SAVE_PATH = os.path.join("/media/mani/Ph.D./PHD_Journals/AK/Explainable ASC/ESC-10", 'PAM_ESC10_CNN.pt') # Define Path to save the model 
#MODEL_SAVE_PATH = os.path.join("/media/mani/Ph.D./PHD_Journals/AK/Explainable ASC/ESC-10", 'PAM_ESC10_CNN_Epoch1.pt') # Define Path to save the model 
MODEL_SAVE_PATH = os.path.join("/media/mani/Ph.D./PHD_Journals/AK/Explainable ASC/ESC-10", 'PAM_ESC10_CNN_Epoch10.pt') # Define Path to save the model 
...
plt.savefig('tSNE_ESC10_PAM_Epoch10.png', bbox_inches='tight') # bbox_inches removes extra white spaces
